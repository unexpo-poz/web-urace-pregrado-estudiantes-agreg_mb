...
$raizDelSitio = 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/agreg_mb/';
$urlDelSitio  = 'http://'.$_SERVER['SERVER_NAME'].'/web/urace';

$lapsoProceso = '2015-2';
$tLapso		  = ' Lapso '.$lapsoProceso;
//$laBitacora			= 'C:/AppServ/www/log/pregrado/estudiantes/inscripcion/inscripcion_'.$lapsoProceso.'.log';

$laBitacora	 = $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/agregados/agregados_'.$lapsoProceso.'.log';
...
$mensajeplanilla	= "<strong>ATENCI&Oacute;N:</strong> Inicio del Lapso Acad&eacute;mico ".$lapsoProceso.": Miercoles 15/10/2014.";

$mensajeppal = "Disculpe, el proceso finaliz&oacute; el 04/05/2015 a las 8:35 am.";
// Variables 
